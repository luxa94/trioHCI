...
//                {
//                    serializerPremises.Serialize(twPremises, new ObservableCollection<Premises>(ctx.Premises));
//                }
//
//                using (TextWriter twTags = new StreamWriter("../../Serialization/tags.xml"))
//                {
//                    serializerTags.Serialize(twTags, new ObservableCollection<Tag>(ctx.Tags));
//                }
//
//                using (TextWriter twTypes = new StreamWriter("../../Serialization/types.xml"))
//                {
//                    serializerTypes.Serialize(twTypes, new ObservableCollection<HCI.Model.Type>(ctx.Types));
//                }
//            }
